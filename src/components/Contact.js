  ...
  return (
    <div className="contact-section">
      ...
      <div className="contact-info-group">
        <p className="contact-info-title">Contact us today for your free estimate.</p>
        <div className="contact-info">
          <p>Phone: <a href="tel:617-945-6666">000-000-0000</a></p>
          <p>Email: <a href="mailto:">email template</a></p>
          <p>Address:</p>
          <a href="https://www.instagram.com/new_wood_designs/?hl=en" target="_blank" rel="noopener noreferrer">
      ...
      <p className="copyright-text">© Created By Kyle Parks</p>
    </div>
  );
};
